...
### 🚗 Uber Revenue Optimization Model — Dynamic Pricing Case Study

Developed a data-driven pricing model to analyze how pricing decisions impact demand, revenue, and profitability using Uber as a case study.

- Built a structured Excel model to simulate demand, pricing, and cost dynamics  
- Conducted scenario analysis to evaluate how pricing changes affect revenue outcomes  
- Identified the trade-off between price and demand using modeled price elasticity  
- Developed a recommendation framework to optimize revenue through dynamic pricing  
